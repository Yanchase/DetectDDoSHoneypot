...
def GetData(dir='/Users/winwin/PycharmProjects/pythonProject/featureextration/ddos.log'):
    data0 = []
    data1 = []
    label0 = []
    label1 = []
...
def classification(train_data,train_label,test_data,test_label):
    ...
    print("logistic训练耗时为:" + str(float(elapse_time * 1000)) + "ms")

    joblib.dump(model, '/Users/winwin/PycharmProjects/pythonProject/tocsv/logical.m', protocol=2)
